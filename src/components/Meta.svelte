...
<svelte:head>
	...
	<meta property="og:image" content="{url}/assets/images/social/social-facebook.jpg" />
	...
	<meta name="twitter:image:src" content="{url}/assets/images/social/social-twitter.jpg" />
